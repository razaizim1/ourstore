...
if (isset($_POST['register_form'])) {
    ...
    if (empty($name)) {
        ...
        $result = $insert->execute(array($name, $username, $email, $mobile, $business_name, $address, $password, $gender, $date_of_birth, $status, $email_code, $mobile_code, $created_at));
        print_r($result);
        if ($result == 1) {
            ...
            $message = "Here is your code:" . $email_code;
